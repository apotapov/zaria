package com.roundtriangles.games.zaria.utils.pathfinding;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import com.roundtriangles.games.zaria.utils.pathfinding.heuristics.ClosestHeuristic;
...
public class AStarPathFinder implements PathFinder, PathFindingContext {
    ...
    private PriorityList<Node> open = new PriorityList<Node>();
     ...
     * @author kevin
     */
    private class PriorityList<T extends Comparable<T>> {
